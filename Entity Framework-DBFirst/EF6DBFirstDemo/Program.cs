    ...
    internal class Program
    {
        ...
        public static void AddUpdateDeleteEntityInConnectedScenario()
        {
            ...
            using (var context = new SchoolDBEntities())
            {
                ...
                var newStudent = context.Students.Add(new Student() { StudentName = "Jonathan", StudentAddress = new StudentAddress() { Address1 = "1, Private Drive", City = "London" } });
                context.SaveChanges(); // Executes Insert commandW
